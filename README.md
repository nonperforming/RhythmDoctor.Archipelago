...
6. (Linux) **Setup Steam launch options**
   Set your Steam launch options to `./run_bepinex.sh "Rhythm Doctor" # %command%`. This is required for BepInEx to be able to run.

7. (Linux) **Configure BepInEx**
